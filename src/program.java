...
public class Program {
	...
	public static void main(String args[]) {
		System.out
				.println("Enter '1' to watch your profile or '2' to watch timetable:");
	...
	public static void init_list() {
		...
		while (s.hasNext())
			stud.add(new Student(s.nextLine(), Gn, Y));
		s.close();
	}
	...
	public static void user_profile() {
		System.out.println("User: " + stud.get(number - 1).name + ". Group: "
				+ stud.get(number - 1).GroupName + ". Created in "
				+ stud.get(number - 1).year + ".");
	}

	public static boolean authorization(String L, String P)
			throws IncorrectAuthorizationData {
		try {
